        ...
        <div class="text-center p-0 m-0 pe-1">
            <div class="row align-items-center mb-4">
                <div class="col container position-relative">
                    <h2 class="text-center mb-0">Lembar Laporan Muhasabah Harian Kelas {{ $className }}</h2>
                </div>
            </div>
        </div>

        <div class="text-center table-responsive">
            <table class="custom-table table table-bordered table-striped table-sm" id="laporanMuhasabahHarianTable">
            </table>
        </div>
    </div>
@endsection
