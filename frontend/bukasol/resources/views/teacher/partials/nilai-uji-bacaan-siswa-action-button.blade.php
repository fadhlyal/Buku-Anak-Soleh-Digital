<div class="container-fluid w-100">
    <div class="d-flex justify-content-center w-100">
        ...
        <a class="btn btn-sm btn-warning py-2 me-2 text-white" href="{{ route('prayer-recitation-grade.teacher-sign-all', ['id' => $studentId]) }}"
        ...
        <form id="approve-form-{{ $studentId }}" method="POST" action="{{ route('prayer-recitation-grade.teacher-sign-all', ['id' => $studentId]) }}" class="d-none">
            @csrf
            @method('PUT')
        </form>
...
<div class="modal fade" id="pdfModal" tabindex="-1" aria-labelledby="pdfModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form action="{{ route('prayer-recitation-grade.convert-pdf', ['id' => $studentId]) }}" method="GET">
